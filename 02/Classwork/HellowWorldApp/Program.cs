	...
	{/// <summary>
	 ...
	 /// <param name="args">args args</param>
		...
		static void Main(string[] args)
		{
			...
			//В остальном операции выполняются справа налево -- 
			//причем, если слева от && будет false или слева от || будет true, то правая часть не вычисляется, а процедуры не выполняются
			Console.WriteLine();
