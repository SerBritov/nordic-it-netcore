...
namespace Reminder.Storage.InMemory.Tests
{
	...
	public class InMemoryReminderStorageTests
	{
		...
		[TestMethod]
		public void Get_Add_Of_Item_With_Already_Added_Id_Throws_ArgumentException()
		{
			// если добавить элемент с одним ID в список,
			// а потом попробовать добавить ещё раз элемент с таким ID,
			// то будет исключение (любое)
